...
# source: candig/metadata/schemas/google/http.proto
...
Http = _reflection.GeneratedProtocolMessageType('Http', (_message.Message,), dict(
  DESCRIPTOR = _HTTP,
  __module__ = 'candig.metadata.schemas.google.http_pb2'
