...
# source: candig/metadata/schemas/google/descriptor.proto
...
FileDescriptorSet = _reflection.GeneratedProtocolMessageType('FileDescriptorSet', (_message.Message,), dict(
  ...
  __module__ = 'candig.metadata.schemas.google.descriptor_pb2'
